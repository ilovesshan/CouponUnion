...
public class Special {
    ...
    public static class Data {
        private TbkDgOptimusMaterialResponse tbk_dg_optimus_material_response;

        public TbkDgOptimusMaterialResponse getTbk_dg_optimus_material_response() {
            return tbk_dg_optimus_material_response;
        }

        public void setTbk_dg_optimus_material_response(TbkDgOptimusMaterialResponse tbk_dg_optimus_material_response) {
            this.tbk_dg_optimus_material_response = tbk_dg_optimus_material_response;
        }

        public static class TbkDgOptimusMaterialResponse {
            ...
            public ResultList getResult_list() {
                return result_list;
            }

            public void setResult_list(ResultList result_list) {
            ...
            public static class ResultList {
                ...
                public void setMap_data(List<MapData> map_data) {
